...
class GoodsDetailsViewController: BaseViewController {
    ...
    func dataAccess() {
        ...
        goodsViewModel.request(goodsId, mallId: mallId, isSearchGoInto: isSearchGoInto, successBlock: { (goodsJson, mallJson, reviewsJson, recommendationJson, lucky_drawJson, basicDataArray, scrollerImageArray, imageArray) in
